...
namespace echoStudy_webAPI.Data
{
    public class DbInitializer
    {
         ...
         */
        public static void addLanguageMaterial(EchoStudyDB context)
        {
            addGermanMaterial(context);
            addJapaneseMaterial(context);
            addSpanishMaterial(context);
        }
        ...
        */
        private static void addJapaneseMaterial(EchoStudyDB context)
        {
            ...
            japaneseDeck3.DefaultFrontLang = Language.English;
            japaneseDeck3.DefaultBackLang = Language.Japanese;
         ...
         * Two of them are public, one of them are private
         */
        private static void addGermanMaterial(EchoStudyDB context)
        {
            // Category for German
            DeckCategory langCategory = new DeckCategory();
            langCategory.Decks = new List<Deck>();
            ...
            germanDeck2.DefaultFrontLang = Language.English;
            germanDeck2.DefaultBackLang = Language.German;
         ...
         * Two of them are public, one of them are private
         */
        public static void addSpanishMaterial(EchoStudyDB context)
        {
            ...
            spanishDeck1.DefaultFrontLang = Language.English;
            spanishDeck1.DefaultBackLang = Language.Spanish;
            ...
            spanishDeck3.DefaultFrontLang = Language.Spanish;
            spanishDeck3.DefaultBackLang = Language.English;
         ...
         */
        public static Card[] createFlashCards(Deck deck, string cardsStringForm)
        {
            // Spanish flash cards
            ...
            for (int i = 0; i < cardsStrings.Length; i++)
            {
                ...
                card.AudioFile = "todo"; // TODO: Audio files 
